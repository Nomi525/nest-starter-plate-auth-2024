...
export class RegisterResultDto extends CreatedIdDto {
  @RequiredBooleanProperty("if the employee/manager needs to enter a confirmation Code. let the ui know if it needs to redirect")
  ...
  @OptionalStringProperty("message")
  message?: string;
}
